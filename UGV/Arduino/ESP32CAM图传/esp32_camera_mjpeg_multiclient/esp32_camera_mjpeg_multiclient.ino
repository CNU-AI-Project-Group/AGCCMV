...
// int motor1Pin1 = 4; // 右前进
// int motor1Pin2 = 2; // 右后退
// int motor1Pin3 = 15; // 左前进 
// int motor1Pin4 = 12; // 左后退 //zy
// int motorA =  1 ;  //左使能
// int motorB =  3; //右使能
...
void setup()
{
  ...
  WiFi.mode(WIFI_STA);
  WiFi.begin("Xiaomi_430F_ROS", "12345678");//WIFI名称和密码
