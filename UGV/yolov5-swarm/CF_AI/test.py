        ...
        if len(aims):
            ...
            if plot:
                ...
                for i, det in enumerate(aims):
                    ...
                    wy = (abs(int(cr1[1]) + int(cr2[1]))) // 2
                    center = (int(img0.shape[1]) // 2, int(img0.shape[0]) // 2)
                    # tyre(center, wx, wy, (cr2[0] - cr1[0], cr2[1] - cr1[1]))
            else:
                pass
                # errortyre()
        else:
